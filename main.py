...
if __name__ == "__main__":
    ...
    n10_matricies = [generate_data(args.prd, N=10, data_dir=args.dir, sampler=baseline_uniform, steps=10) for i in range(100)]
    n100_matricies = [generate_data(args.prd, N=100, data_dir=args.dir, sampler=baseline_uniform, steps=10) for i in range(100)]
